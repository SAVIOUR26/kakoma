...
<section class="section-alt">
    <div class="container">
        <div class="section-header">
            <span class="eyebrow">15 August 2026</span>
            <h2>The Old Students' Fundraising Dinner</h2>
        ...
        <p class="text-center" style="margin-top:24px;">
            <a href="gallery.php" class="btn btn-navy">View Full Gallery</a>
            <a href="blog-post.php?slug=old-students-fundraising-dinner-2026" class="btn btn-outline" style="border-color:var(--navy); color:var(--navy);">Read the Full Story</a>
        </p>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="timeline">
            <div class="timeline-item">
                ...
                <p class="muted">Kakoma Secondary School opens its doors in Rakai District, on land given by the Kingdom of Kooki through the vision of founding families. Read the full story on <a href="history.php">Our History</a>.</p>
            </div>
            <div class="timeline-item">
            ...
            <div class="timeline-item">
                ...
                <h3>A Headteacher Who Was Once a Student</h3>
                <p class="muted">Bbale David, a Kakoma old student, now leads the school as Head Teacher — heading into the Diamond Jubilee year.</p>
            </div>
            <div class="timeline-item">
                <span class="year">15 Aug 2026</span>
                <h3>Old Students' Fundraising Dinner</h3>
            ...
            <div class="timeline-item">
                ...
                <p class="muted">Kakoma Secondary School marks 60 years — full programme details coming soon on our <a href="events.php">Events</a> page.</p>
            </div>
        </div>
    </div>
</section>
